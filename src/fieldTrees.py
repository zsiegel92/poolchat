...
poolfields = {
	...
	"eventTime":nodeOb(nType="String",nTitle="the time of your event",nQuestion="What is the time your event starts?",next="menu",nodeName="Event Time",verboseNode=True,obField='Pool'),

	"menu":nodeOb(nType="String",nTitle="whether you'd like to edit your information",nQuestion="Would you like to change the following?\n{_all}",next='quick_menu',quickChoices={"All good!":'mode',"Address":'eventAddress',"Time":'eventTime'},verboseNode=True,obField='Pool'),

	"mode":nodeOb(nType="String",nTitle="everything you've entered.",nQuestion="Is all of the following correct?\n{_all}",next='quick_menu',quickChoices={"Yes, I want to go!":"tripfields","Need to edit event..":"menu"},verboseNode=True,obField='Pool')
}


tripfields = {

"address":nodeOb(nType="String",nTitle="the address you'll be coming from",nQuestion="Now I know your personal information and about your event.\nWhat is the address you'll be coming from?\n (I know you'll be going TO {pool_eventAddress})",verboseNode=True,next="num_seats",nodeName="Address",obField='Trip'),
	...
	"preWindow":nodeOb(nType="Integer",nTitle="the earliest you can be ready to go",nQuestion="What is the earliest you can leave your house before the event at {pool_eventAddress}?",next="on_time",quickChoices={"15 mins before event":'15',"20 mins before event":'20',"25 Minutes":'25',"30 Minutes":'30',"40 Minutes":'40',"45 Minutes":'45',"1 Hour":'60',"1 Hour 15 Minutes":'75'},verboseNode=True,nodeName="Minutes Available for Transit",obField='Trip'),

	"on_time":nodeOb(nType="Integer",nTitle="your inability to be late (1 or 0)",nQuestion="Do you have to arrive on time? Can you be 30 minutes late? Please answer 1 if you are an organizer of this event or 0 otherwise.",next="must_drive",quickChoices={"Can be a bit late":'0',"Must arrive on time":'1'},nodeName="Have to Arrive on Time",obField='Trip'),
	...
	"menu":nodeOb(nType="String",nTitle="whether you'd like to edit your information",nQuestion="Would you like to change the following?\n{_all}",next='quick_menu',quickChoices={"All good!":'mode',"Address":'address',"Number of seats":'num_seats',"Drivetime Limit":'preWindow',"Arrival Flexibility":'on_time',"Must drive own car":'must_drive'},verboseNode=True,obField='Trip'),

	"mode":nodeOb(nType="String",nTitle="everything you've entered.",nQuestion="What would you like to do now?",quickChoices={"Create NEW carpool":"CREATE_NEW_POOL","JOIN a carpool":"FIND_POOL","Need to go back...":'RESPONSE/Carpooler/menu'},disable_prefix=True,verboseNode=True,obField='Trip')
