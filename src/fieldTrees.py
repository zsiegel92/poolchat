...
fields = {
    ...
    "menu":nodeOb("String","whether you'd like to edit your information","Would you like to edit your information?",next='quick_menu',quickChoices={"Name":'name',"Email":'email',"Address:":'address',"Number of seats":'num_seats',"Drivetime Limit":'preWindow',"Arrival Flexibility":'on_time',"Must drive own car":'must_drive'})
}
