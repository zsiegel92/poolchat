...
tripfields = {
	...
	"preWindow":nodeOb(nType="Integer",fieldname='preWindow',nTitle="the earliest you can be ready to go",nQuestion="What is the earliest you can leave before the event at {pool_eventAddress}, at {pool_eventTime}?\n(You will be coming from {address})",customAfterText="OK, now I know that you can leave {response} minutes before the event starts on {pool_eventDate} at {pool_eventTime}.",next="on_time",quickChoices=OrderedDict([("15 mins before event",'15'),("20 mins before event",'20'),("25 Minutes",'25'),("30 Minutes",'30'),("40 Minutes",'40'),("45 Minutes",'45'),("1 Hour",'60'),("1 Hour 15 Minutes",'75')]),verboseNode=True,prefix='CONFIRM_PREWINDOW/',nodeName="Minutes Available for Transit",obField='Trip'),
