...
def main():
	...
	a=bax()
	for ind,gp in enumerate(a.bax_gen(13,4)):
		print(str(ind) + ": " + str(gp.toList()) + ", invert: " + str(en.invert(gp.toList())) + ", en.generateSubset(4," + str(ind) +"): " + str(en.generateSubset(4,ind)) )
