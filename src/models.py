...
class Carpooler(db.Model):
    ...
    fields = {
        ...
        "num_seats":nodeOb("Integer","the number of seats in your car (0 if you have no car)","How many seats are there in your car? Please input a number; enter 0 if you cannot drive to the event.","preWindow",quickChoices={"I don't have a car":'0',"1 seat (only me)":'1',"2 seats":'2'}),
        ...
        "on_time":nodeOb("Integer","your ability to be late (1 or 0)","Do you have to arrive on time? Can you be 30 minutes late? Please answer 1 if you are an organizer of this event or 0 otherwise.","must_drive",quickChoices={"Can be a bit late":'0',"Must arrive on time":'1'}),
        
        "must_drive":nodeOb("Integer","your REQUIREMENT to drive (1 for \"have to drive\"; 0 for \"don't have to drive\")","Do you have to drive, or is catching a ride an option? Please answer Yes if you have to drive, or No otherwise.","name",quickChoices={"Can drive or ride":'0',"Must drive own car":'1'})
    }
