...
#IMPORTS FOR TESTING:
from interactions import toDB, getStarted,newPool,joinPool,findPool,switchCurrentPool,pester #NOTE These are NOT needed for app - only for drop_populate and testing!
...
def testing():
    try:
        ...
        text_rules(fbId,'DTLA 6TH ST')#email
        text_rules(fbId,'7:30pm')#email
