...
.config(['$routeProvider', function($routeProvider) {
	...
	.controller('registerController', ['$scope', '$location', '$log', 'AuthService', '$window', '$routeParams',
					...
					.then(function(response) {
						...
						if (status == 200) {
							...
							if (status == 203) {
								...
								var go_to_pool_id = response.go_to_pool_id;
								...
								$location.path('/viewPool/join_pool/' + response.go_to_pool_id);
							}
							else {
